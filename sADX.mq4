...
int getDirection()
{
  double adx = iADX(Symbol(), PERIOD_M1, IND_PERIOD, PRICE_TYPICAL, 0, 0);
  double pDI = iADX(Symbol(), PERIOD_M1, IND_PERIOD, PRICE_TYPICAL, 1, 0);
  double nDI = iADX(Symbol(), PERIOD_M1, IND_PERIOD, PRICE_TYPICAL, 2, 0);
//  Print("ADX(M1, 3)=", adx);
//  Print("+DI(M1, 3)=", pDI);
//  Print("-DI(M1, 3)=", nDI);
